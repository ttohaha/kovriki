...
import img_bg_call1 from '../../img2/bg_call1.JPG'
import img_bg_call2 from '../../img2/bg_call2.JPG'
import img_call_cover from '../../img/call_cover.png'
import img_call_men from '../../img2/call_men.png'
import img_call_men2 from '../../img/call_men2.png'
import img_call_women from '../../img2/call_women.png'
    ...
    <div className="podlozka_call">
        <div className="call">
            <div className="call_main">
                ...
                <img src={img_call_men} alt="" className="call_men_img_mobile" />
            </div>
            ...
            <img src={img_bg_call1} alt="" className="bg_call" />
        </div>
    </div>
)
}
