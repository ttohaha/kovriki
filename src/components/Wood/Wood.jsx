      ...
      <div className="wood">
          <div className="wood_main">
              <div className="wood_textiscrol">
                ...
                <div className="wood_text">А это пример нашей работы<br/> Из щёток зубных - именные творим<br/>С подарком коллега не будет заботы,<br/>Бамбуковая щётка уже не мейнстрим!</div>
              </div>
