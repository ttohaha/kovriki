...
import img_girleprice1 from '../../img2/girleprice1.png'
import img_girleprice2 from '../../img2/girleprice2.png'
import bg_price from '../../img2/bg_price.JPG'
...
function Price() {
  ...
  <div className="podlozka_1">
    <div className='price_comp'>
      ...
      <img src={bg_price} alt="" className="bg_price" />
    </div>
  </div>
